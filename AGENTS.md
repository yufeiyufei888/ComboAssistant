...
- Keep combo buttons locked in normal mode; only the purple settings ball may be dragged directly. Combo-button position/size/opacity changes belong to the transactional layout mode.
